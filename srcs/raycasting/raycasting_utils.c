...
/*   Updated: 2024/05/24 12:50:24 by ilbendib         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void draw_thick_pixel(t_cub *cub, int x, int y, int color, int thickness)
// {
...
// {
//     int thickness = 2; // Définir l'épaisseur de la ligne
...
//             raycast->hit = 1;
//         }
//         // Dessin des pixels épais pour chaque étape du rayon
//         int pixel_x = raycast->map_x * TILE_SIZE;
//         int pixel_y = raycast->map_y * TILE_SIZE;
//         draw_thick_pixel(cub, pixel_x, pixel_y, 0x00FF0000, thickness);
//     }
// }
